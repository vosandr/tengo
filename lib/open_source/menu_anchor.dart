              ...
              child: Semantics(
                ...
                child: TextButton(
                  ...
                  child: _MenuItemLabel(
                    ...
                    hasSubmenu: true,
                    showDecoration:
                        (controller._anchor!._parent?._orientation ??
                                Axis.horizontal) ==
                            Axis.vertical,
                    child: child,
                  ),
...
class _SubmenuDirectionalFocusAction extends DirectionalFocusAction {
  ...
  void invoke(DirectionalFocusIntent intent) {
    assert(_debugMenuInfo(
        '${intent.direction}: Invoking directional focus intent.'));
...
class _Submenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (layerLink == null) {
      ...
      bottomRight = anchorBox.localToGlobal(anchorBox.paintBounds.bottomRight,
          ancestor: overlay);
    }
